        ...
        <div class="page-content--bge5">
            <div class="container">
                        <div style="background-color: rgb(201, 235, 235);" class="col-md-8  m-t-100  m-l-250 p-b-50  ">
                            <form class="leave-comment"  action="php/login.php" method="POST" >
                                ...
                                <div class="bo4 of-hidden size15 m-b-20">
                                    <input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="phone-number" placeholder="Password">
                                </div>
